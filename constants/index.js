...
const EVENTS_CONDUCTED = [
  ...
  },
  {
    ...
    overview: 'Commence Synchronisation was the fourth official event organized by Hyperspace XR SIG and the first of the 2026-27 academic year, designed as an introductory session to orient incoming second-year students to the world of Extended Reality. Held over 100 minutes across eight structured phases, the event brought together 43 participants for a programme that combined technical explanations of AR, VR, MR, and XR with a live showcase of the SIG\'s own archery game developed in Unity, a forward-looking discussion on XR career opportunities, and a competitive interactive quiz. The session also served as a springboard for the SIG\'s next initiative, concluding with the official announcement and publicity drive for the Texture Distortion Blender workshop.',
...
const FAQ_C = [
  ...
  { id: 5, question: 'Are all the events conducted by Hyperspace inter-college?', answer: "No. Most of our events are open to all." },
  { id: 6, question: 'Does Hyperspace only conduct events?', answer: "No. The main purpose behind building this SIG was to increase awareness about the XR domain and train students from all over Pune to be industry ready XR development experts. Hyperspace, also has the extensive responsibility to connect different industry professionals and companies together with the students. We also help students gain internship and job opportunites with comapanies that are tied up with us." },
